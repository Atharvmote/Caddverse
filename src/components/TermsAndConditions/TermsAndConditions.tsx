      ...
      <div className="container">
        ...
        <div className="terms-header-centered">
          ...
          <p className="section-desc">
            Please read these terms and conditions carefully before using our services or enrolling in any <strong style={highlightStyle}>CADDVERSE TEACHLABS</strong> program.
          </p>
        </div>
        ...
        <div className="terms-content-card">
          ...
          <div className="terms-section">
            ...
            <ul className="terms-list">
              <li><strong style={highlightStyle}>Caddverse Techlabs</strong> ("the Site") is an online learning solution providing platform which includes sale of learning resources and online learning courses for individual users for different educational domains. The terms and conditions set forth hereinafter are applicable to all visitors or users of the Site. The site is branded under the name of Caddverse TechlabsLearning.com</li>
              <li>The Site is created, updated and maintained by Caddverse Techlabs Solutions LLP (CADDVERSE TECHLABS) and the name, design and the model are <strong style={highlightStyle}>exclusive property</strong> of CADDVERSE TECHLABS. Any copy and / or reproduction in any form and/or <strong style={highlightStyle}>unauthorized access</strong> to any data forming part of the Site will amount to infringement of copyright laws and international treaty provisions.</li>
              ...
              <li>CADDVERSE TECHLABS may, at its sole discretion, <strong style={highlightStyle}>change the Fee Structure/cost/price</strong> at any time without prior intimation. Add-ons to the Fees, such as but not limited to, taxes, duties or other levies are payable by recipients of subscription service as per the <strong style={highlightStyle}>governing laws of India</strong> or foreign countries.</li>
              ...
              <li>The content in different programs has been prepared by a team of subject experts. While designing the questions, the team has referred to a number of books, question papers, study material and other resources available in the market. Every effort has been made to ensure that <strong style={highlightStyle}>no infringement of any copyright</strong> happens. In case any discrepancy is reported corrective action would be taken immediately by CADDVERSE TECHLABS.</li>
              <li>It is clearly understood that the use of the Service by the User is only for purposes of <strong style={highlightStyle}>self-learning and continuous improvement</strong>. A poor score in such self-learning is not meant to discourage the user. The test sessions are only for practice and self assessment. CADDVERSE TECHLABS accepts no liability on this account.</li>
          ...
          <div className="terms-section">
            ...
            <ul className="terms-list">
              ...
              <li>Whenever a User enrolls by agreeing to subscribe to the Service choosing payment through <strong style={highlightStyle}>Credit Card</strong> as the mode of payment, User shall authorize CADDVERSE TECHLABS to <strong style={highlightStyle}>realize the full fee</strong> for the Service in advance.</li>
              ...
              <li>Once the payment has been realized <strong style={highlightStyle}>no refund / cancellation will be made on any ground</strong>, including non-usage of the Service.</li>
              <li>The User needs to select his or hers own login ID and password. The user is <strong style={highlightStyle}>entirely responsible for maintaining the confidentiality</strong> of the login ID and its password. The user shall ensure that he/she exits from the account at the end of each session by signing out. CADDVERSE TECHLABS takes no responsibility and shall stand totally indemnified by the user for any or all consequences caused by any <strong style={highlightStyle}>unauthorized use of the user's account</strong> by any third-party.</li>
              ...
              <li><strong style={highlightStyle}>UNDER NO CIRCUMSTANCES WILL CADDVERSE TECHLABS BE LIABLE TO THE USER FOR ANY DAMAGES</strong>, SUCH AS, BUT NOT LIMITED TO, LOSS OF DATA, LOST TIME OR OPPORTUNITIES, PROFITS, OR FOR ANY MISHAPS DUE TO IMPROPER USAGE, DIRECT, INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL OR EXEMPLARY DAMAGES, ARISING FROM THE SUBJECT MATTER OF THIS AGREEMENT, REGARDLESS OF THE TYPE OF CLAIM AND EVEN IF CADDVERSE TECHLABS HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</li>
              <li>This Agreement shall be governed by the <strong style={highlightStyle}>Laws of India</strong>. The Courts of law at <strong style={highlightStyle}>Vadodara, Gujarat</strong> shall have exclusive jurisdiction over any disputes arising under this Agreement.</li>
